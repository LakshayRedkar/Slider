//import { mydata } from "./data/nward_update.js";
import { mydata } from "./data/nward_alldata.js";
// console.log(feature.properties.s_date);
...
function returnColorCode(d)
{
  ...
  function style(feature) {
     var value_for_data;
      if (data_type === 'dryWaste') {
        ...
        value_for_data= feature.properties.dry_waste;
      } else if (data_type === 'wetWaste') {
        value_for_data=feature.properties.wet_waste;
      } else if (data_type === 'totalWaste') {
        value_for_data=feature.properties.total_waste;
      } else if (data_type === 'weight') {
        value_for_data= feature.properties.weight;
      }
  
    return {
      fillColor: getColor(data_type,value_for_data),
      weight: 2,
      opacity: 1,
      color: "white",
      dashArray: "3",
  ...
  var geojson = L.geoJSON(selectedFeatures, {
    style: style,
